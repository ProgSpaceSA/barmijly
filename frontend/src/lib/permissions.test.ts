...
const EXPECTED: Record<Action, UserRole[]> = {
  ...
  "meeting:read": ["PROJECT_MANAGER", "PROGRAMMING_HEAD", "SENIOR_MANAGEMENT"],
  "meeting:manage": ["PROJECT_MANAGER", "PROGRAMMING_HEAD", "SENIOR_MANAGEMENT"],
  "requirement:read": ["SYSTEM_OWNER", "DEVELOPER", "QA", "PROJECT_MANAGER", "PROGRAMMING_HEAD", "SENIOR_MANAGEMENT"],
  "requirement:create": ["PROJECT_MANAGER", "PROGRAMMING_HEAD", "SENIOR_MANAGEMENT"],
  "requirement:triage": ["PROJECT_MANAGER", "PROGRAMMING_HEAD", "SENIOR_MANAGEMENT"],
  "requirement:promote": ["PROJECT_MANAGER", "PROGRAMMING_HEAD", "SENIOR_MANAGEMENT"],
  ...
  "tool:read": ["TICKET_REQUESTER", "SYSTEM_OWNER", "DEVELOPER", "QA", "PROJECT_MANAGER", "PROGRAMMING_HEAD", "SENIOR_MANAGEMENT"],
  "tool:request": ["DEVELOPER", "QA", "PROJECT_MANAGER", "PROGRAMMING_HEAD", "SENIOR_MANAGEMENT"],
  "tool:manage": ["PROJECT_MANAGER", "PROGRAMMING_HEAD", "SENIOR_MANAGEMENT"],
  "feedback:read": ["TICKET_REQUESTER", "SYSTEM_OWNER", "DEVELOPER", "QA", "PROJECT_MANAGER", "PROGRAMMING_HEAD", "SENIOR_MANAGEMENT"],
  "feedback:create": ["TICKET_REQUESTER", "SYSTEM_OWNER", "DEVELOPER", "QA", "PROJECT_MANAGER", "PROGRAMMING_HEAD", "SENIOR_MANAGEMENT"],
  "feedback:triage": ["PROJECT_MANAGER", "PROGRAMMING_HEAD", "SENIOR_MANAGEMENT"],
